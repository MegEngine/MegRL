...
class AtariA2CConfig(BaseConfig):
    ...
    def __init__(self, taskname):
        ...
        env = envpool.make_gymnasium(self.DATA.TASK_NAME_ENVPOOL,
                                     stack_num=self.DATA.TRAINING_ENV_ARGS["stack_num"])
        ...
        self.MODEL.BACKBONE.CONFIGURATIONS_MLP = {
            "input_channels": self.DATA.TRAINING_ENV_ARGS["stack_num"],
            "output_dim": 0 ,
        ...
        self.MODEL.A2C_VALUE_FUNC_COEFF = 0.25
        ...
        self.SOLVER.WEIGHT_DECAY = 0.0001
