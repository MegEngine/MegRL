...
class ClassicPPOConfig(BaseConfig):
    ...
    def __init__(self, taskname):
        ...
        self.MODEL.N_STEP = 3
        # ppo special
        self.MODEL.PPO_VALUE_FUNC_COEFF = 0.5
        ...
        self.SOLVER.MAX_EPOCH = 5
        self.MODEL.STEP_PER_COLLECT = 2000
        self.SOLVER.NUM_ENV_STEP_PER_EPOCH = 50000
        self.SOLVER.NUM_ENV_EPISODE_PER_EPOCH = None
        self.MODEL.UPDATE_PER_STEP = None
    ...
    def build_model(self):
        ...
        for k,v in preprocess_net.named_parameters():
            print(k, v.mean())
        actor = a_cls(
...
class ClassicContPPOConfig(BaseConfig):
    ...
    def __init__(self, taskname):
        ...
        self.MODEL.EPISODE_PER_COLLECT = 16
        self.SOLVER.NUM_ENV_STEP_PER_EPOCH = 50000
        self.SOLVER.NUM_ENV_EPISODE_PER_EPOCH = None
